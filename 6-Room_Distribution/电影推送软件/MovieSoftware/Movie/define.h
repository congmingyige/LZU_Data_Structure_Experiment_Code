...
struct user
{
    ...
    //Preference:偏好(喜剧1、爱情2、动作3、动画4、剧情5、悬疑6、科幻7、冒险8、犯罪/战争9、不填0)
...
struct movie
{
    ...
    //Category:模式(喜剧1、爱情2、动作3、动画4、剧情5、悬疑6、科幻7、冒险8、犯罪/战争9、不填0)
...
//历史记录
extern long total_history;
extern char history[500][100];
//推荐信息
extern long total_introduce;
extern char introduce[500][100];
